...
type HealthCheckClient interface {
	Hello(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error)
}
...
func (c *healthCheckClient) Hello(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
	out := new(HealthCheckResponse)
	err := c.cc.Invoke(ctx, "/proto.healthCheck/hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthCheckServer interface {
	Hello(context.Context, *Empty) (*HealthCheckResponse, error)
...
func (UnimplementedHealthCheckServer) Hello(context.Context, *Empty) (*HealthCheckResponse, error) {
...
func _HealthCheck_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HealthCheckServer).Hello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.healthCheck/hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthCheckServer).Hello(ctx, req.(*Empty))
	}
...
var HealthCheck_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "hello",
			Handler:    _HealthCheck_Hello_Handler,
		},
	},
